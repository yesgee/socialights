...
describe('Action: deleteQuestion', function() {
  ...
  it('should require a question ID', function(done) {
    api.specHelper.runAction('deleteQuestion', {}, function(response) {
  ...
  it('should return an error for a non-existing question', function(done) {
    api.specHelper.runAction('deleteQuestion', { id: new api.mongo.ObjectID().toString() }, function(response) {
      should.exist(response.error);
      should.not.exist(response.success);
  ...
  it('should delete an existing question', function(done) {
