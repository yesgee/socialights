...
describe('Action: showRoom', function() {
  ...
  it('should require a room ID', function(done) {
    api.specHelper.runAction('showRoom', {}, function(response) {
  ...
  it('should return an error for a non-existing room', function(done) {
    api.specHelper.runAction('showRoom', { id: new api.mongo.ObjectID().toString() }, function(response) {
      should.exist(response.error);
      should.not.exist(response.success);
  ...
  it('should return an existing room', function(done) {
    var room = new api.models.Room(randomRoom());
    room.save(function(err) {
      should.not.exist(err);
      api.specHelper.runAction('showRoom', { id: room.id }, function(response) {
