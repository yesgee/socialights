...
exports.default = {
  general: function(api) {
    return {
      apiVersion: '0.0.1-wip',
      serverName: 'SociaLights API',
      ...
      welcomeMessage: 'Hello! Welcome to the SociaLights api',
      // the redis prefix for actionhero's cache objects
      cachePrefix: 'socialights:cache:',
      // the redis prefix for actionhero's cache/lock objects
      lockPrefix: 'socialights:lock:',
